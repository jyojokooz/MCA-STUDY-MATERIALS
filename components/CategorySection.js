    ...
    return (
      <div className="mb-8" data-name="category-section" data-file="components/CategorySection.js">
        <div className="flex items-center gap-3 mb-4">
          <div className={`w-10 h-10 ${color} rounded-xl border-2 shadow-[2px_2px_0px_0px_rgba(0,0,0,0.9)] flex items-center justify-center ${
          ...
          <div>
            ...
            }`}>{courses.length} course{courses.length !== 1 ? 's' : ''}</p>
          </div>
        </div>
          ...
          {sortedCourses.map(course => (
            course.active !== false ? (
              course.code === '20MCA245' ? (
                <div
                  key={course.code}
                  className={`border-2 border-purple-400 rounded-xl p-6 flex flex-col items-center justify-center shadow-[2px_2px_0px_0px_rgba(0,0,0,0.09)] select-none ${
                ...
                >
                  ...
                  }`}>Mini Project Coming Soon</div>
                  <div className={`text-xs font-bold mb-2 ${
                    isDarkMode ? 'text-gray-400' : 'text-gray-500'
                  }`}>20MCA245</div>
                  <div className={`font-semibold mb-2 text-center ${
                    isDarkMode ? 'text-purple-300' : 'text-purple-700'
                  }`}>Want to showcase your Mini Project? <br/> Email: <a href='mailto:24mp2275@rit.ac.in' className='underline text-blue-400'>24mp2275@rit.ac.in</a></div>
                  <a
                ...
                <div
                  key={course.code}
                  className={`border-2 border-indigo-400 rounded-xl p-6 flex flex-col items-center justify-center shadow-[2px_2px_0px_0px_rgba(0,0,0,0.09)] select-none ${
                ...
                >
                  ...
                  }`}>Main Project Coming Soon</div>
                  <div className={`text-xs font-bold mb-2 ${
                    isDarkMode ? 'text-gray-400' : 'text-gray-500'
                  }`}>20MCA246</div>
                  <div className={`font-semibold mb-2 text-center ${
                    isDarkMode ? 'text-indigo-300' : 'text-indigo-700'
                  }`}>Want to showcase your Main Project? <br/> Email: <a href='mailto:24mp2275@rit.ac.in' className='underline text-blue-400'>24mp2275@rit.ac.in</a></div>
                  <a
              ...
              <div
                key={course.code}
                className={`border-2 border-yellow-400 rounded-xl p-6 flex flex-col items-center justify-center shadow-[2px_2px_0px_0px_rgba(0,0,0,0.09)] opacity-80 select-none ${
